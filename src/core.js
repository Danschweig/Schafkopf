    ...
    const THEMES={
      ...
      light:{mode:"light",bg1:"#fffef8",bg2:"#edf5e7",border:"#7f9a76",text:"#102817",title:"#061a0b",dim:"#2e5b36",mute:"#496a4d",pageBg:"linear-gradient(160deg,#fffdf2,#e1efd9)",topbarBg:"#fffdf6",inputBg:"#fff9df",roundBg:"#dfeeda",navBg:"#fffdf6",navActive:"#155f23",subBg:"#c8e6c1",subBorder:"#427d46",subText:"#0d4719",buttonBg:"#f3ead0",buttonBorder:"#7d8f62",buttonText:"#18351d",buttonShadow:"0 2px 7px rgba(45,72,36,0.18)",switchOff:"#d2dcc8",switchOn:"#2f7d36",switchKnob:"#ffffff",switchKnobOff:"#687a60",chartGrid:"#c1d4ba",chartAxis:"#3f6745",tooltipBg:"#fffef8",zero:"#6f8370",purpleBg:"#f5edff",successBg:"#dff0d8",themeColor:"#fffdf2"}
    };
    let C=THEMES.dark;
    function createStyles(C){
      return {
        ...
        btn:(on,ac="#5a9a5a")=>({background:on?ac+(C.mode==="light"?"38":"24"):C.buttonBg,border:`1px solid ${on?ac:C.buttonBorder}`,color:on?ac:C.buttonText,borderRadius:7,padding:"8px 12px",cursor:"pointer",fontSize:12,fontFamily:"'Courier New',monospace",fontWeight:C.mode==="light"?600:400,transition:"all 0.15s",boxShadow:on&&C.mode==="light"?`inset 0 0 0 1px ${ac}55, 0 1px 5px rgba(45,72,36,0.12)`:C.buttonShadow}),
        pBtn:(on,col)=>({flex:1,padding:"10px 4px",textAlign:"center",background:on?col+(C.mode==="light"?"3d":"22"):C.buttonBg,border:`2px solid ${on?col:C.buttonBorder}`,color:on?col:C.buttonText,borderRadius:8,cursor:"pointer",fontSize:12,fontFamily:"'Courier New',monospace",fontWeight:C.mode==="light"?600:400,transition:"all 0.15s",boxShadow:on&&C.mode==="light"?`inset 0 0 0 1px ${col}55, 0 1px 5px rgba(45,72,36,0.12)`:C.buttonShadow}),
        ...
        pChip:(on,col)=>({background:on?col+(C.mode==="light"?"3d":"22"):C.buttonBg,border:`1px solid ${on?col:C.buttonBorder}`,color:on?col:C.buttonText,borderRadius:20,padding:"5px 14px",cursor:"pointer",fontSize:11,fontFamily:"'Courier New',monospace",fontWeight:C.mode==="light"?600:400,transition:"all 0.15s",boxShadow:C.mode==="light"?C.buttonShadow:"none"}),
      };
    }
